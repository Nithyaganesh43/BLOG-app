...
res.redirect(`/auth/newUserInfo?fullname=${userData.fullName}&email=${userData.email}&platform=${userData.platform}&profileUrl=${userData.profileUrl}`); 
}
...
res.cookie('token',jwt, {
  ...
  res.redirect(`${FRONT_END_URL}/src/AuthPage/newUserInfo.html?fullname=${fullname}&email=${email}&platform=${platform}&profileUrl=${profileUrl}`);
});
